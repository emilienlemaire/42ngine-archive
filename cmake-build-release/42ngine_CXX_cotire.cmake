...
set (COTIRE_TARGET_COMPILE_DEFINITIONS_RELEASE "FT_PLATFORM_APPLE;GLFW_DLL;NDEBUG")
set (COTIRE_TARGET_COMPILE_FLAGS_RELEASE "-O3;-std=gnu++14;-isysroot;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk")
...
set (COTIRE_TARGET_INCLUDE_DIRECTORIES_RELEASE "/usr/local/include;/usr/local/Cellar/opencv@2/2.4.13.7_5/include;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk/System/Library/Frameworks/OpenGL.framework;/usr/local/Cellar/glfw/3.3/include")
...
set (COTIRE_TARGET_SOURCES "src/Window.cpp;src/VertexArray.cpp;src/VertexBuffer.cpp;src/Shader.cpp;src/IndexBuffer.cpp;src/Application.cpp;src/Renderer.cpp;src/Camera.cpp;src/BufferLayout.cpp;src/Texture.cpp")
